...
namespace comprenXible_API.Controllers
{
    ...
    public class ChatbotResponsesController : ControllerBase
    {
        ...
        public bool GetChatbotResponses(ChatbotResponse chatbotResponse)
        {
            ...
            //This to the DBB mañana si eso
            //keywords
            foreach (var word in chatbotResponse.Response)
            {
                if (word == "miserable" ||
                    word == "despreciable" ||
                    word == "siempre" ||
            ...
            if (chatbotWordsScore >= 3)
            {
                ...
                chatbotWordsScore = 3;
                double chatbotScore = ChatbotScoreCalculation(chatbotResponse.Response, chatbotWordsScore, elapsedTime);
                return true;
            }
